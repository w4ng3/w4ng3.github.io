...
<p>TypeScript 是一种由微软开发的自由和开源的编程语言，它是 JavaScript 的一个超集，扩展了 JavaScript 的语法。</p>
</blockquote>
<h2 id="语法特性" tabindex="-1"><a class="header-anchor" href="#语法特性" aria-hidden="true">#</a> 语法特性</h2>
<ul>
<li>类 Classes</li>
<li>接口 Interfaces</li>
<li>模块 Modules</li>
...
<h2 id="tolearn" tabindex="-1"><a class="header-anchor" href="#tolearn" aria-hidden="true">#</a> toLearn</h2>
<ul>
