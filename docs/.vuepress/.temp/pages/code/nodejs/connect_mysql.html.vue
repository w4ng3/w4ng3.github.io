...
<span class="token comment">// ]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>connection.query</code>方法可以用来查询，并且执行任意正确的sql语句。接受第一个参数就是一个sql语句字符串，第二个参数是执行sql语句后的回调函数。</p>
<h2 id="orm-和sequelize" tabindex="-1"><a class="header-anchor" href="#orm-和sequelize" aria-hidden="true">#</a> ORM 和Sequelize</h2>
<p>如果直接使用这个mysql包提供的接口访问数据库，我们编写的代码就比较底层，因为是直接写SQL命令来访问的。</p>
<p>其实数据库的表是一个二维表，可以有多行多列。这个表的结构可以映射成一个JS对象，每一行都可以用一个对象来表示。每个列的字段就是对象里的每个属性。这个就是ORM技术：Object-Relational Mapping 就是把关系数据库的表结构映射到对象上。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Sequelize的核心概念就是模型。在Sequelize里，模型就是一个继承了<code v-pre>Model</code>的类，它相当于数据库里的一张表的结构。由这个类创建出来的一个实例对象，相当于表里的一行。<br>
首先<code v-pre>new Sequelize</code>创建一个<code v-pre>sequelize</code>连接对象，包含了连接到的mysql数据库的信息。然后声明一个模型叫Book。</p>
<ul>
<li>用<code v-pre>Book.init</code>对这个模型初始化，就是对表初始化，有哪些属性（列）及其数据类型。第二个参数就是要连接的对象。</li>
<li><code v-pre>sequelize.sync()</code>用来同步我们这个模型和表，因为可能表已经存在，或者有不同的列，所以要先同步一下。</li>
<li><code v-pre>Book.create</code>用模型创建一个实例对象，就是在表中添加一行数据。这个都是异步的，相当于一个promise，所以用await非常简洁。</li>
<li><code v-pre>Book.findAll</code> 用于查询</li>
</ul>
