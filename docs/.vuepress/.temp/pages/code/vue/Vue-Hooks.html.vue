...
<ul>
<li>将可复用功能抽离为外部 js 文件</li>
<li>函数名文件名以<code v-pre>use</code>开头，形如 useXXX</li>
<li>引用时，在 setup 中解构出自定义 hooks 的变量和方法，如: <code v-pre>const { name } = useXXX()</code></li>
</ul>
<h2 id="hook-的意义" tabindex="-1"><a class="header-anchor" href="#hook-的意义" aria-hidden="true">#</a> Hook 的意义</h2>
<ul>
<li>提取重复逻辑，优化代码结构</li>
<li>代替 Mixin</li>
<li>体现编程思想</li>
...
<span class="token keyword">import</span> useMousePosition <span class="token keyword">from</span> <span class="token string">"@/hooks/useMousePosition"</span><span class="token punctuation">;</span>
...
<blockquote>
<p>Compostion API 最核心要解决的问题并不是逻辑复用，而是==逻辑关注点分离==。因为应用生命周期 60%时间都是在维护的，而维护性体现在代码是否符合单一职责原则，单一职责就是把相同的业务代码内聚到一个地方。</p>
...
<li><a href="https://qdmana.com/2022/207/202207261252551584.html#1_hooks_5" target="_blank" rel="noopener noreferrer">Vue3 学习笔记 4 自定义 hooks<ExternalLinkIcon/></a></li>
