...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>$ pnpm add --save lodash
...
<p>接下来是将它封装为一个抽象组件</p>
<CodeTabs id="23" :data='[{"id":"debounce.js"},{"id":"Abstract.vue"}]' tab-id="language">
<template #title0="{ value, isActive }">debounce.js</template>
<template #title1="{ value, isActive }">Abstract.vue</template>
<template #tab0="{ value, isActive }">
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> defineComponent <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"vue"</span><span class="token punctuation">;</span>
...
<p><img src="https://riddler.oss-cn-shanghai.aliyuncs.com/blog/debounce.gif" alt="防抖" loading="lazy">
