...
<blockquote>
<p>naive-ui 组件库的源码就是使用 tsx 写的</p>
</blockquote>
...
<p>来源：<a href="https://www.zhihu.com/question/436260027/answer/1661092534" target="_blank" rel="noopener noreferrer">为什么 Vue3 的组件库都在使用 jsx/tsx？ - 阿崔 cxr 的回答 - 知乎 <ExternalLinkIcon/></a></p>
<div class="hint-container info">
<p class="hint-container-title">template：</p>
...
<p class="hint-container-title">jsx</p>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// setup 直接返回一个函数</span>
<span class="token keyword">const</span> Foo <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// render 中实现</span>
<span class="token keyword">const</span> Foo <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token function">setup</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">const</span> count <span class="token operator">=</span> <span class="token function">ref</span><span class="token punctuation">(</span><span class="token number">0</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<h2 id="jsx-简明语法" tabindex="-1"><a class="header-anchor" href="#jsx-简明语法" aria-hidden="true">#</a> JSX 简明语法</h2>
<p><a href="https://juejin.cn/post/7114063575122984973" target="_blank" rel="noopener noreferrer">《Vue3 中使用 JSX 简明语法》<ExternalLinkIcon/></a></p>
<h2 id="demo-vite-vue-jsx" tabindex="-1"><a class="header-anchor" href="#demo-vite-vue-jsx" aria-hidden="true">#</a> Demo Vite + Vue + JSX</h2>
<figure><img src="https://riddler.oss-cn-shanghai.aliyuncs.com/blog/20220731000050.png" alt="demo-jsx" tabindex="0" loading="lazy"><figcaption>demo-jsx</figcaption></figure>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>pnpm add @vitejs/plugin-vue-jsx
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><CodeTabs id="60" :data='[{"id":"JsxComp.jsx"},{"id":"Hello.vue"},{"id":"vite.config.js"}]' tab-id="language">
<template #title0="{ value, isActive }">JsxComp.jsx</template>
<template #title1="{ value, isActive }">Hello.vue</template>
<template #title2="{ value, isActive }">vite.config.js</template>
...
<span class="token keyword">import</span> JsxComp <span class="token keyword">from</span> <span class="token string">"../components/JsxComp"</span><span class="token punctuation">;</span>
<span class="token comment">// 原本的渲染函数组件</span>
<span class="token keyword">const</span> <span class="token function-variable function">Bar</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span>
  <span class="token function">h</span><span class="token punctuation">(</span>AnchoredHeading<span class="token punctuation">,</span> <span class="token punctuation">{</span> <span class="token literal-property property">level</span><span class="token operator">:</span> <span class="token number">1</span> <span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token punctuation">[</span><span class="token function">h</span><span class="token punctuation">(</span><span class="token string">"span"</span><span class="token punctuation">,</span> <span class="token string">"Hello"</span><span class="token punctuation">)</span><span class="token punctuation">,</span> <span class="token string">"-world!"</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<h2 id="demo-在-setup-surge-中使用-jsx" tabindex="-1"><a class="header-anchor" href="#demo-在-setup-surge-中使用-jsx" aria-hidden="true">#</a> Demo 在 setup surge 中使用 jsx</h2>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
...
<p><a href="https://juejin.cn/post/7114063575122984973" target="_blank" rel="noopener noreferrer">《Vue3 中使用 JSX 简明语法》<ExternalLinkIcon/></a></p>
<p><a href="https://www.zhihu.com/question/436260027/answer/1661092534" target="_blank" rel="noopener noreferrer">为什么 Vue3 的组件库都在使用 jsx/tsx？ - 阿崔 cxr 的回答 - 知乎 <ExternalLinkIcon/></a></p>
...
<p><a href="https://cn.vitejs.dev/plugins/" target="_blank" rel="noopener noreferrer">vite 官方插件<ExternalLinkIcon/></a></p>
</div></template>
