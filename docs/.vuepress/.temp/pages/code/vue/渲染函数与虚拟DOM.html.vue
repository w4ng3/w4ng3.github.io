...
<a href="https://v3.cn.vuejs.org/guide/render-function.html#dom-%E6%A0%91" target="_blank" rel="noopener noreferrer">DOM 树 🌲<ExternalLinkIcon/></a>
<a href="https://v3.cn.vuejs.org/guide/render-function.html#%E8%99%9A%E6%8B%9F-dom-%E6%A0%91" target="_blank" rel="noopener noreferrer">虚拟 DOM 树<ExternalLinkIcon/></a></p>
<h2 id="虚拟-dom-的性能到底如何" tabindex="-1"><a class="header-anchor" href="#虚拟-dom-的性能到底如何" aria-hidden="true">#</a> 虚拟 DOM 的性能到底如何？</h2>
<p>《Vue.js 设计与实现》第 4 ～ 11 页</p>
<blockquote>
<p>总而言之，虚拟 DOM 更新技术的性能理论上不可能比原生 JavaScript 操作 DOM 性能要高，但在大部分情况下，菜鸡 🐔 很难写出绝对优化的命令式代码，而虚拟 DOM 能够保证程序性能的下限。</p>
</blockquote>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="使用-jsx" tabindex="-1"><a class="header-anchor" href="#使用-jsx" aria-hidden="true">#</a> 使用 JSX</h2>
<p>移步另一篇：<a href="https://w2gd.top/code/vue/%E5%9C%A8Vue%E4%B8%AD%E4%BD%BF%E7%94%A8JSX%E8%AF%AD%E6%B3%95.html" target="_blank" rel="noopener noreferrer">在 Vue 中使用 JSX 语法<ExternalLinkIcon/></a></p>
<h2 id="参考" tabindex="-1"><a class="header-anchor" href="#参考" aria-hidden="true">#</a> 参考</h2>
<ul>
<li><a href="https://v3.cn.vuejs.org/guide/render-function.html" target="_blank" rel="noopener noreferrer">Vue.js 官网——渲染函数<ExternalLinkIcon/></a></li>
<li><a href="https://v3.cn.vuejs.org/guide/composition-api-setup.html#%E4%BD%BF%E7%94%A8%E6%B8%B2%E6%9F%93%E5%87%BD%E6%95%B0" target="_blank" rel="noopener noreferrer">Vue.js 官网——setup 里使用渲染函数<ExternalLinkIcon/></a></li>
<li><a href="https://segmentfault.com/a/1190000022277663" target="_blank" rel="noopener noreferrer">对虚拟 DOM 和 Dom-Diff 的理解？<ExternalLinkIcon/></a></li>
<li><a href="https://www.yisu.com/zixun/154392.html" target="_blank" rel="noopener noreferrer">vue 中 render 函数的作用是什么<ExternalLinkIcon/></a></li>
<li><a href="https://juejin.cn/post/6949829240330125325" target="_blank" rel="noopener noreferrer">记一个 Vue 渲染函数 render 的使用场景<ExternalLinkIcon/></a></li>
