...
![img](./FILES/flutterguan-jian-ji-shu.md/9e9b14ba.png)
...
![img](./FILES/flutterguan-jian-ji-shu.md/84bad9ba.png)
...
首先，我们来看一下 Flutter 的架构图。通过这张图以及对应的解读，我们应该在开始学习的时候就建立起对 Flutter 的整体印象，能够从框架设计和实现原理的高度去理解 Flutter 区别其他跨平台解决方案的关键所在，为后面的学习打好基础，而不是直接一上来就陷入语言和框架的功能细节“泥潭”而无法自拔。

![Img](./FILES/flutterguan-jian-ji-shu.md/img-20220911203249.png)
...
![img](./FILES/flutterguan-jian-ji-shu.md/f5cf7377.png)
:::center
图 6 Flutter 绘制示例
:::
...
![img](./FILES/flutterguan-jian-ji-shu.md/ec5453e3.png)
:::center
图 7 Flutter 重绘边界
:::
...
![img](./FILES/flutterguan-jian-ji-shu.md/78e5fee9.jpeg)
:::center
图 8 Flutter 知识体系
:::
